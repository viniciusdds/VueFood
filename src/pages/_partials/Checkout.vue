    ...
    <modal name="checkout">
      ...
      <div class="px-md-5 my-4" v-else>
        <div class="col-12" v-if="me.name !== ''">
          ...
          <div class="btn btn-success btn-full" @click.prevent="createOrder">Fazer Pedido</div>
        </div>
        <div v-else class="row">
          <div class="col-6">
            ...
            <div class="btn btn-info btn-full" @click.prevent="createOrder">Fazer Pedido de Forma Anônima</div>
          </div>
          <div class="col-6">
